...
static if (IMGUI_IMPL_OPENGL_ES2) {
    ...
    IM_ASSERT(cast(int)(glsl_version.length) + 2 < IM_ARRAYSIZE(g_GlslVersionString));
    strcpy(g_GlslVersionString.ptr, glsl_version.ptr);
...
static if (IMGUI_IMPL_OPENGL_MAY_HAVE_PRIMITIVE_RESTART) {
    if (g_GlVersion >= 310)
...
static if (!IMGUI_IMPL_OPENGL_ES2) {
    ...
    glVertexAttribPointer(g_AttribLocationVtxPos,   2, GL_FLOAT,         GL_FALSE, sizeof!(ImDrawVert), cast(GLvoid*)(ImDrawVert.pos.offsetof));
    glVertexAttribPointer(g_AttribLocationVtxUV,    2, GL_FLOAT,         GL_FALSE, sizeof!(ImDrawVert), cast(GLvoid*)(ImDrawVert.uv.offsetof));
    glVertexAttribPointer(g_AttribLocationVtxColor, 4, GL_UNSIGNED_BYTE, GL_TRUE,  sizeof!(ImDrawVert), cast(GLvoid*)(ImDrawVert.col.offsetof));
}
...
//#endif
    ...
    io.Fonts.SetTexID(cast(ImTextureID)cast(intptr_t)g_FontTexture);
